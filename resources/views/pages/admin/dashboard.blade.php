    ...
    <section class="w-full min-h-screen bg-gradient-to-b from-neutral-900 via-neutral-950 to-neutral-900 flex items-start justify-center py-10">
        <div class="w-full max-w-3/4 flex flex-col items-center gap-12">
            ...
            <div class="w-full flex flex-col items-center gap-4">
                ...
                <a href="{{ route('home-section') }}" class="w-full border border-white/75 text-white/75 hover:text-white bg-transparent hover:bg-white/20 transition p-4 flex items-center select-none justify-between">
                ...
                <a href="{{ route('about-section') }}" class="w-full border border-white/75 text-white/75 hover:text-white bg-transparent hover:bg-white/20 transition p-4 flex items-center select-none justify-between">
                    <div class="flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 8.25V18a2.25 2.25 0 0 0 2.25 2.25h13.5A2.25 2.25 0 0 0 21 18V8.25m-18 0V6a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 6v2.25m-18 0h18M5.25 6h.008v.008H5.25V6ZM7.5 6h.008v.008H7.5V6Zm2.25 0h.008v.008H9.75V6Z" />
                        </svg>                          
                ...
                <a href="{{ route('project-section') }}" class="w-full border border-white/75 text-white/75 hover:text-white bg-transparent hover:bg-white/20 transition p-4 flex items-center select-none justify-between">
                    <div class="flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 8.25V18a2.25 2.25 0 0 0 2.25 2.25h13.5A2.25 2.25 0 0 0 21 18V8.25m-18 0V6a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 6v2.25m-18 0h18M5.25 6h.008v.008H5.25V6ZM7.5 6h.008v.008H7.5V6Zm2.25 0h.008v.008H9.75V6Z" />
                        </svg>                          
                ...
                <a href="{{ route('app-settings') }}" class="w-full border border-white/75 text-white/75 hover:text-white bg-transparent hover:bg-white/20 transition p-4 flex items-center select-none justify-between">
                    <div class="flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                        ...
                        <div class="tag inline-flex items-center w-fit before:content-['#'] text-white/90 font-light text-sm lg:text-base px-3 py-1 bg-gray-600 rounded-full">
                            ...
                            <div class="flex items-center before:content-['|'] before:ms-2 gap-2">
                                <form action="{{ route('toggle-tag', $t->id) }}" method="post" class="flex items-center">
                                    @csrf
                                    @if ($t->is_active === true)
                                    <button type="submit" class="cursor-pointer hover:text-white/75 transition" title="Deactivate">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                                        </svg>                                                                 
                                    </button>
                                    @else
                                    <button type="submit" class="cursor-pointer hover:text-white/75 transition" title="Activate">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                ...
                                <form action="{{ route('delete-tag', $t->id) }}" method="POST" class="flex items-center">
                                    @csrf
                                    <button type="submit" class="cursor-pointer hover:text-white/75 transition" title="Delete">
